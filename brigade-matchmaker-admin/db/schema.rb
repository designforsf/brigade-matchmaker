...
ActiveRecord::Schema.define(version: 2019_08_29_021954) do
  ...
  create_table "category_taxonomies", force: :cascade do |t|
    t.integer "category_id", null: false
    t.integer "taxonomy_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_category_taxonomies_on_category_id"
    t.index ["taxonomy_id"], name: "index_category_taxonomies_on_taxonomy_id"
  end
  ...
  add_foreign_key "category_taxonomies", "categories"
  add_foreign_key "category_taxonomies", "taxonomies"
